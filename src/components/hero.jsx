    ...
    return (
        <div>
            ...
            <div className="flex overflow-y-hidden scrollbar-hide gap-4 overflow-x-auto mx-6 md:ml-16">
                ...
                <div className=" mt-6 bg-white p-4 rounded-2xl flex-shrink-0  transition-transform duration-300 transform hover:scale-105 hover:rotate-x-2 hover:rotate-y-2 hover:shadow-xl w-96" >
                    <h2 className="font-semibold text-lg md:text-2xl" >Save on Mac and iPad for college, choose AirPods or an eligible accessory.</h2>
                    <img className="md:w-3/4" src={p1}></img>
                </div>

                <div className="bg-white mt-6 p-4 rounded-2xl flex-shrink-0 transition-transform duration-300 transform hover:scale-105 hover:rotate-x-2 hover:rotate-y-2 hover:shadow-xl w-96" >
              ...
              <div className="bg-white mt-6 p-4 rounded-2xl flex-shrink-0 transition-transform duration-300 transform hover:scale-105 hover:rotate-x-2 hover:rotate-y-2 hover:shadow-xl w-96">
                ...
                <div className="bg-white mt-6 p-4 rounded-2xl flex-shrink-0 transition-transform duration-300 transform hover:scale-105 hover:rotate-x-2 hover:rotate-y-2 hover:shadow-xl w-96">
                 ...
                 <div className="bg-white mt-6 p-4 rounded-2xl flex-shrink-0 transition-transform duration-300 transform hover:scale-105 hover:rotate-x-1 hover:rotate-y-1 hover:shadow-xl w-96">
                    <p className="text-red-500">OFFER ELIGIBLE</p>
